...
what matchsticks the little match girl has, please find out a way you can make one square
by using up all those matchsticks. You should not break any stick, but you can link them up,
...
class Solution(object):
    def makesquare(self, nums):
        ...
        if sum % 4 != 0:
            return False
        return self.dfs(nums, [0 for _ in range(4)], 0, sum/4)
...
soluton = Solution()
print soluton.makesquare([1,1,2,2,2])